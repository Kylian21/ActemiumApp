      ...
      switch (_provider.pageState) {
        ...
        case 4:
          return Align(
              alignment: Alignment.center,
              child: Padding(
                padding: EdgeInsets.only(top: ConfigSize.blockSizeVertical * 5),
                child: Column(
                        ...
                        Card(
                          ...
                          shape: ContinuousRectangleBorder(
                              side: BorderSide(
                                  ...
                                  width: ConfigSize.blockSizeHorizontal * 0.5)),
                          child: Padding(
                            padding: EdgeInsets.all(
                                ConfigSize.blockSizeHorizontal * 5.5),
                            child: FlatButton(
                              onPressed: () {
                                _provider.pageState = 1;
                              },
                              child: Text(
                                "BÂCHER",
                                style: TextStyle(
                                    fontSize:
                                        ConfigSize.blockSizeVertical * 2.5,
